...
init <- c(
  p_cc = 1.523624e-10, p_dd = 9.677735e-01, p_uu = 9.778265e-01,
  mu_d = -1.094364e+00, mu_u = 8.477106e-01, mu_c = -8.124726e+01,
  eta_d=1, eta_u=1, eta_c=1,
  
  
  phi1 = -4.802414e-02,
  
  psi_1.1 = -6.715577e-02, 
  psi_2.1 = -6.121069e-02, 
  psi_3.1 = 9.355791e-01, 
  psi_4.1 = 2.199894e-01, 
  
  gamma_1.0 = 1.709769e-01, 
  gamma_2.0 = 1.455477e-01, 
  gamma_3.0 = 3.043101e-01,
  gamma_4.0 = 2.003255e-01, 
  
  sigma_1 = 6.920490e-01, sigma_2 = 7.823108e-01,
  sigma_3 = 7.012891e-03, sigma_4 = 4.999822e-01
)
...
# # Non-negativity constraints
diag(ineqA[c(24, 25, 26), grepl("eta_", colnames(ineqA))]) <- 1
...
write.csv(Ctt, "Data/3-DFM-mean-variance-factor.csv")
write.csv(prob, "Data/3-DFM-mean-variance-prob.csv")
write.csv(estimates, "estimerte parametere/3-DFM-mean-variance-estimates.csv")
write.csv(standard_errors, "estimerte parametere/3-DFM-mean-variance-standard_errors.csv")
write.csv(y_pred, "Data/3-DFM-mean-variance-predictions.csv")
...
write.csv(metrics, "estimerte parametere/3-DFM-mean-variance-metrics.csv")
