...
init <- c(
  p_dd = 9.666481e-05, p_uu = 9.970773e-01,
  mu_d = -1.772435e+01, mu_u = 2.653452e-02,
...
write.csv(Ctt, "Data/2-DFM-mean-factor.csv")
write.csv(prob, "Data/2-DFM-mean-prob.csv")
write.csv(estimates, "estimerte parametere/2-DFM-mean-estimates.csv")
write.csv(standard_errors, "estimerte parametere/2-DFM-mean-standard_errors.csv")
write.csv(y_pred, "Data/2-DFM-mean-predictions.csv")
...
write.csv(metrics, "estimerte parametere/2-DFM-mean-metrics.csv")
