...
fetch_series_data <- function(series_id) {
  fredr_series_observations(series_id = series_id) %>%
    ...
    filter(date >= as.Date("1940-01-01") & date <= as.Date("2019-12-31")) %>%
...
init <- c(
  ...
  sigma_1 = 0.722467, sigma_2 = 0.988551,
  sigma_3 = 0.126601, sigma_4 = 0.108575
...
# export ----
write.csv(Ctt, "Data/2019-1-DFM-factor.csv")

write.csv(estimates, "estimerte parametere/2019-1-DFM-estimates.csv")
write.csv(standard_errors, "estimerte parametere/2019-1-DFM-standard_errors.csv")
write.csv(y_pred, "Data/2019-1-DFM-predictions.csv")
...
write.csv(metrics, "estimerte parametere/2019-1-DFM-metrics.csv")
