...
# init <- c(
#   p_cc = 2.301280e-12, p_dd = 9.785465e-01, p_uu = 9.776130e-01, p_mm = 0.9,
#   mu_d = -1.084697e+00, mu_u = 8.512865e-01, mu_c = -8.124757e+01, mu_m = 0.01,
# 
#   phi1 = -4.400592e-02,
# 
#   psi_1.1 = -7.722669e-02,
#   psi_2.1 = -6.694934e-02,
#   psi_3.1 = 9.680653e-01,
#   psi_4.1 = 1.989165e-01,
# 
#   gamma_1.0 = 1.709131e-01,
#   gamma_2.0 = 1.442878e-01,
#   gamma_3.0 = 3.028775e-01,
#   gamma_4.0 = 2.038348e-01,
# 
#   sigma_1 = 6.842715e-01, sigma_2 = 7.781647e-01,
#   sigma_3 = 3.699127e-03, sigma_4 = 4.853061e-01
# )

init <- c(
  p_cc = 1.664729e-10, p_dd = 8.356983e-01, p_uu = 8.529030e-01, p_mm = 8.903220e-01,
  ...
  sigma_3 = 2.640245e-06, sigma_4 = 4.574641e-01
)
...
# Set the constraints
ineqA <- matrix(0, nrow = 26, ncol = length(init), dimnames = list(NULL, names(init)))
...
ineqA[21, "mu_c"] <- -1
ineqA[c(22, 23), "p_cc"] <- c(1, -1)

ineqA[24, "mu_m"] <- 1
ineqA[c(25, 26), "p_mm"] <- c(1, -1)
...
write.csv(Ctt, "Data/4-DFM-mean-factor.csv")
write.csv(prob, "Data/4-DFM-mean-prob.csv")
write.csv(estimates, "estimerte parametere/4-DFM-mean-estimates.csv")
write.csv(standard_errors, "estimerte parametere/4-DFM-mean-standard_errors.csv")
write.csv(y_pred, "Data/4-DFM-mean-predictions.csv")
...
write.csv(metrics, "estimerte parametere/4-DFM-mean-metrics.csv")
