...
# Set the constraints
ineqA <- matrix(0, nrow = 23, ncol = length(init), dimnames = list(NULL, names(init)))
...
write.csv(Ctt, "Data/3-DFM-mean-factor.csv")
write.csv(prob, "Data/3-DFM-mean-prob.csv")
write.csv(estimates, "estimerte parametere/3-DFM-mean-estimates.csv")
write.csv(standard_errors, "estimerte parametere/3-DFM-mean-standard_errors.csv")
write.csv(y_pred, "Data/3-DFM-mean-predictions.csv")
...
write.csv(metrics, "estimerte parametere/3-DFM-mean-metrics.csv")
